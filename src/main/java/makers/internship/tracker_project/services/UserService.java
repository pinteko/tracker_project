...
import makers.internship.tracker_project.entities.Role;
...
public class UserService implements UserDetailsService {
    ...
    public User findById(Long id) {return userRepository.findById(id).orElseThrow(() -> new ExistEntityException("User not found"));}
